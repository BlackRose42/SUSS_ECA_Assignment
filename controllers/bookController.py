...
def update():
    ...
    return {"success": True, "message": "Booking has been updated"}, 200
...
def delete():
    ...
    return {"success": True, "message": "Booking has been deleted"}, 200
...
def cancel():
    try:
        ...
        return {"success": True, "message": "Booking has been cancelled"}, 200
    except ValueError as e:
        return {"success": False, "message": f"Error cancelling booking"}, 500
